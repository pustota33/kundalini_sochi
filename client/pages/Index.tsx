  ...
  <div className="grid gap-8 md:grid-cols-2 rounded-3xl bg-secondary/60 p-4 sm:p-6 ring-1 ring-border">
    ...
    <div className="mx-auto w-full max-w-md md:relative grid grid-cols-2 gap-3 items-start">
      ...
      <img
        ...
        alt="Денис"
        className="w-full aspect-[4/5] rounded-2xl object-cover shadow-xl ring-1 ring-border md:absolute md:bottom-2 md:right-2 md:w-64 md:shadow-2xl md:ring-2 md:ring-background rotate-90"
      />
